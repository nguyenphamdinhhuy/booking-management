...
<div class="form-wrapper">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input id="email" placeholder="Nhập email của bạn" type="email" class="form-control" name="email" value="{{ old('email') }}" autofocus>
            @error('email')
        ...
        <div class="social-login">
            ...
            <a href="{{ url('/auth/zalo') }}" class="social-btn zalo">
