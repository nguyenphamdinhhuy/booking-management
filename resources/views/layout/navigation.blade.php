  ...
  <header class="bk-header">
    <div class="bk-header__bar">
      ...
      <div class="bk-header__actions">
        <a href="#" class="bk-header__action-btn bk-header__action-signup">Đăng ký</a>
        <a href="login.html" class="bk-header__action-btn bk-header__action-login">Đăng nhập</a>
      </div>
      <!-- Mobile menu button -->
    ...
    <nav class="bk-header__mobile-nav" aria-label="Mobile menu">
      ...
      <ul>
        ...
        <li><a href="#" class="bk-header__action-btn bk-header__action-signup"><i class="fa-solid fa-user-plus"></i> Đăng ký</a></li>
        <li><a href="#" class="bk-header__action-btn bk-header__action-login"><i class="fa-solid fa-right-to-bracket"></i> Đăng nhập</a></li>
      </ul>
    </nav>
