...
<div class="table-container">
    ...
    <div class="table-header">
        <h2 class="table-title">Danh sách loại phòng đã xóa (<span id="roomTypeCount">{{ $roomTypes->count() }}</span> loại phòng)</h2>
        <div class="table-actions">
            ...
            <a href="{{ route('admin.roomType.restoreAll') }}"
            ...
            <a href="{{ route('admin.roomType.forceDeleteAll') }}"
    ...
    <!-- Filter Bar -->
    <form id="filterForm" method="GET" action="{{ route('admin.roomType.trash') }}">
        <div class="filter-bar">
            ...
            <div class="filter-group" style="align-items: end;">
                ...
                <a class="btn btn-secondary" href="{{ route('admin.roomType.trash') }}">Xóa bộ lọc</a>
            </div>
        </div>
    </form>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.roomType.restore', $roomType->rt_id) }}"
                            ...
                            @if(Auth::check() && Auth::user()->role === 'admin')
                            <a href="{{ route('admin.roomType.forceDelete', $roomType->rt_id) }}"
...
<script>
    ...
    function clearFilters() {
        window.location.href = "{{ route('admin.roomType.trash') }}";
    }
