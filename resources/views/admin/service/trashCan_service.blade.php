    ...
    <div class="table-container">
        ...
        <div class="table-header">
            ...
            <div class="table-actions">
                <a onclick="return confirm('Bạn có chắc chắn muốn xoá?')" href="{{ route('service.delete_all') }}"
                    class="btn btn-danger">
                    <i class="fas fa-trash"></i> Xóa tất cả
                </a>
                <a onclick="return confirm('Bạn muốn khôi phục tấy cả?')" href=" {{ route('service.restore_all') }}"
        ...
        <!-- Filter Bar -->
        <form method="GET" action="{{ route('service.trashCan') }}">
            <div class="filter-bar">
                ...
                <div class="filter-group">
                    ...
                    <input type="date" name="deleted_from" id="deleted_from" value="{{ request('deleted_from') }}"
                        class="filter-input" onchange="document.getElementById('deleted_to').min = this.value">
                </div>

                <div class="filter-group">
                    <label class="filter-label">Ngày xóa (đến)</label>
                    <input type="date" name="deleted_to" id="deleted_to" value="{{ request('deleted_to') }}"
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a onclick="return confirm('Bạn có chắc muốn khôi phục san phẩm')"
                                        href="{{ route('service.restore', $sv->s_id) }}" class="btn btn-warning btn-sm"
                                        title="Khôi phục">
                                        <i class="fas fa-undo"></i>
                                    </a>
                                    <form action="{{ route('service.deleted', $sv->s_id) }}" method="POST"
        ...
        <script>
            function clear_Filters() {
                ...
                window.location.href = "{{ route('service.trashCan') }}";
            }
        </script>
    </div>
