...
<div class="profile-container">
    ...
    <div class="profile-content">
        <div class="profile-card">
            ...
            <form method="post" action="{{ $isAdmin ? route('admin.settings.update') : route('profile.settings.update') }}" class="profile-form">
                @csrf
                @method('put')
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <input type="text" id="site_name" name="site_name" 
                                       value="{{ old('site_name', $user->site_name ?? 'Booking Management') }}" 
                                       class="form-input">
                            </div>
                        </div>
                        ...
                        <div class="setting-item">
                            ...
                            <div class="setting-control">
                                <textarea id="site_description" name="site_description" rows="3" 
                                          class="form-input">{{ old('site_description', $user->site_description ?? '') }}</textarea>
                            </div>
                        </div>
    ...
    <div class="setting-control">
        <label class="switch">
            <input type="checkbox" id="enable_email_verification" name="enable_email_verification"
                {{ setting('enable_email_verification') ? 'checked' : '' }}>
                            ...
                            <div class="setting-control">
                                <label class="switch">
                                    <input type="checkbox" id="maintenance_mode" name="maintenance_mode" 
                                           {{ ($user->maintenance_mode ?? false) ? 'checked' : '' }}>
                                    <span class="slider"></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="setting-control">
                                <label class="switch">
                                    <input type="checkbox" id="registration_enabled" name="registration_enabled" 
                                           {{ ($user->registration_enabled ?? true) ? 'checked' : '' }}>
                                    <span class="slider"></span>
                                </label>
                            </div>
                        </div>
