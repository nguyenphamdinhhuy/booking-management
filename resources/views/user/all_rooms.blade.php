...
{{-- Hero Section cho trang All Rooms --}}
...
<section class="rooms-section">
    <div class="rooms-container">
        <div class="rooms-header">
            ...
            <div class="rooms-stats">
                ...
                <p class="rooms-subtitle">
                    Tìm thấy {{ $stats['total_rooms'] ?? 0 }} phòng
                    ({{ $stats['available_rooms'] ?? 0 }} còn trống, {{ $stats['unavailable_rooms'] ?? 0 }} hết phòng)
                </p>
                @else
        ...
        <div class="rooms-list">
            ...
            <a href="{{ route('rooms_detail', ['id' => $room->r_id]) }}" class="room-card {{ !$room->available ? 'room-unavailable' : '' }}">
                <div class="room-image">
                    <img src="{{ $room->images ? asset($room->images) : asset('assets/images/default-room.jpg') }}"
                        alt="{{ $room->name }}">
                ...
                <div class="room-info">
                    <div class="room-header">
                        ...
                        <div class="room-rating">
                            <span class="rating-score">{{ $room->rating ?? '4.5' }}</span>
                            <span class="rating-text">
                                @if(($room->rating ?? 4.5) >= 4.5)
                                Tuyệt vời
                                @elseif(($room->rating ?? 4.5) >= 4.0)
                                Rất tốt
                                @elseif(($room->rating ?? 4.5) >= 3.5)
                                Tốt
                                @else
                                Khá tốt
                                @endif
