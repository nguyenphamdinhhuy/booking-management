...
@section('content')
    <<<<<<< HEAD=======<div class="booking-wrapper">
        >>>>>>> 6b796dc31814fcd7f46ef63e2a5889ed96625f44
                        ...
                        <div class="booking-section">
                            ...
                            <div class="booking-details">
                                ...
                                <div class="booking-info">
                                    ...
                                    <div class="booking-info-list">
                                        <div class="booking-info-item"><span>Tên phòng:</span> {{ $room->name ?? 'N/A' }}
                                        </div>
                                        ...
                                        <div class="booking-info-item"><span>Số đêm:</span> {{ $booking->nights ?? 1 }} đêm
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="booking-contact">
                                ...
                                <p><i class="fas fa-info-circle"></i> Chúng tôi sẽ liên hệ trước ngày nhận phòng để xác nhận
                                    thông
                                    tin.</p>
                            </div>
                        </div>
