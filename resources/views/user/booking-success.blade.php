                        ...
                        <div class="booking-box">
                                    ...
                                    <div class="booking-info">
                                        ...
                                        <div class="booking-info-list">
                                            <div class="booking-info-item"><span>Mã đơn:</span>
                                                <strong>#{{ $booking->b_id }}</strong>
                                            </div>
                                            <div class="booking-info-item"><span>Khách hàng:</span>
                                                {{ $user->name ?? 'N/A' }}</div>
                                            <div class="booking-info-item"><span>Email:</span>
                                                {{ $user->email ?? 'N/A' }}</div>
                                            <div class="booking-info-item"><span>Trạng thái:</span> <span
                                                    class="booking-status">Đã thanh toán</span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="booking-info">
                                        ...
                                        <div class="booking-info-list">
                                            ...
                                            <div class="booking-info-item"><span>Giá/đêm:</span>
                                                {{ $room->formatted_price ?? 'N/A' }}</div>
                                            <div class="booking-info-item"><span>Số khách:</span>
                                                {{ $details->guests ?? 'N/A' }} người</div>
                                            <div class="booking-info-item"><span>Số đêm:</span>
                                                {{ $booking->nights ?? 1 }} đêm</div>
                                        </div>
                                    ...
                                    <div class="booking-box">
                                        ...
                                        <div class="booking-section">
                                            ...
                                            <div class="booking-details">
                                                <div class="booking-info">
                                                    ...
                                                    <div class="booking-info-list">
                                                        ...
                                                        <div class="booking-info-item"><span>Email:</span>
                                                            {{ $user->email ?? 'N/A' }}</div>
                                                        <div class="booking-info-item"><span>Trạng thái:</span>
                                                            <span class="booking-status">Đã
                                                                thanh toán</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="booking-info">
                                                    ...
                                                    <div class="booking-info-list">
                                                        ...
                                                        <div class="booking-info-item"><span>Giá/đêm:</span>
                                                            {{ $room->formatted_price ?? 'N/A' }}
                                                        </div>
                                                        <div class="booking-info-item"><span>Số khách:</span>
                                                            {{ $details->guests ?? 'N/A' }} người
                                                        </div>
                                                        <div class="booking-info-item"><span>Số đêm:</span>
                                                ...
                                                <div class="booking-date-box">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="booking-date-value">
                                                            {{ $booking->formatted_check_in ?? 'N/A' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="booking-date-box">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="booking-date-value">
                                                            {{ $booking->formatted_check_out ?? 'N/A' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="booking-summary">
                                                ...
                                                <div class="booking-info-list">
                                                    <div class="booking-info-item">
                                                        <span>Giá phòng ({{ $booking->nights ?? 1 }}
                                                            đêm):</span>
                                                        {{ number_format(($room->price_per_night ?? 0) * ($booking->nights ?? 1), 0, ',', '.') }}
                                                        VND
                                                    </div>
                                                    @if($voucher)
                                                        <div class="booking-info-item">
                                                            <span>Mã giảm giá ({{ $voucher->v_code ?? '' }}):</span>
                                                            -{{ number_format($details->discount_amount ?? 0, 0, ',', '.') }}
                                                            VND
                                                        </div>
                                                    @endif
                                            ...
                                            @if($room && $room->images)
                                                <div class="booking-room-preview">
                                                    ...
                                                    <div class="booking-room-box">
                                                        <img src="{{ asset($room->images) }}" class="booking-room-image"
                                                            alt="{{ $room->name }}">
                                                        <div class="booking-room-details">
                                                            ...
                                                            <div class="booking-room-tags">
                                                                <span><i class="fas fa-users"></i>
                                                                    {{ $room->max_guests ?? 'N/A' }} khách</span>
                                                                <span><i class="fas fa-bed"></i>
                                                                    {{ $room->number_beds ?? 'N/A' }} giường</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="booking-contact">
                                                ...
                                                <p><i class="fas fa-phone"></i> Hotline: <strong>1900
                                                        1234</strong></p>
                                                <p><i class="fas fa-envelope"></i> Email:
                                                    <strong>support@hotel.com</strong>
                                                </p>
                                                <p><i class="fas fa-info-circle"></i> Chúng tôi sẽ liên hệ trước
                                                    ngày nhận phòng để xác nhận
                                                    thông
                                                    tin.</p>
                                            </div>
                                        </div>
                            ...
                            <div class="booking-dates">
                                <div class="booking-date-box">
                                    ...
                                    <div>
                                        <div class="booking-date-label">Ngày nhận phòng</div>
                                        <div class="booking-date-value">{{ $booking->formatted_check_in ?? 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="booking-date-box">
                                    ...
                                    <div>
                                        <div class="booking-date-label">Ngày trả phòng</div>
                                        <div class="booking-date-value">{{ $booking->formatted_check_out ?? 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="booking-room-preview">
                                    ...
                                    <div class="booking-room-box">
                                        ...
                                        <div class="booking-room-details">
                                            ...
                                            <p>{{ $room->description ?? 'Không có mô tả' }}</p>
                                            <div class="booking-room-tags">
                                                <span><i class="fas fa-users"></i> {{ $room->max_guests ?? 'N/A' }}
                                                    khách</span>
                                                <span><i class="fas fa-bed"></i> {{ $room->number_beds ?? 'N/A' }}
                                                    giường</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="booking-contact">
                                ...
                                <p><i class="fas fa-info-circle"></i> Chúng tôi sẽ liên hệ trước ngày nhận phòng để
                                    xác nhận thông tin.</p>
                            </div>
                        </div>
                    </div>
                </div>
