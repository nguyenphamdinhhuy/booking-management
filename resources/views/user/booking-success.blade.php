                    ...
                    <div class="booking-details">
                        <div class="booking-info">
                            ...
                            <div class="booking-info-list">
                                <div class="booking-info-item"><span>Mã đơn:</span> <strong>#{{ $booking->b_id }}</strong>
                                </div>
                        ...
                        <div class="booking-info">
                            ...
                            <div class="booking-info-list">
                                ...
                                <div class="booking-info-item"><span>Giá/đêm:</span> {{ $room->formatted_price ?? 'N/A' }}
                                </div>
                                <div class="booking-info-item"><span>Số khách:</span> {{ $details->guests ?? 'N/A' }} người
                                </div>
