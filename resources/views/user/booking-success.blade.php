...
@section('content')
<div class="bks"> {{-- SCOPED WRAPPER, tránh xung đột --}}
        ...
        <div class="bks-grid">
                ...
                <div class="bks-section">
                        ...
                        <div class="bks-info">
                            ...
                            <div class="bks-info__list">
                                ...
                                <div class="bks-info__row">
                                    ...
                                    @php $paid = isset($isPaid) ? $isPaid : ((int)($booking->payment_status ?? 0) === 1); @endphp
                                    @if($paid)
                        ...
                        <div class="bks-info">
                            ...
                            <div class="bks-info__list">
                                <div class="bks-info__row">
                                    ...
                                    {{ $roomType->type_name ?? 'N/A' }}
                                </div>
                                <div class="bks-info__row">
                                    <span>Giá/đêm:</span>
                                    {{ $roomType->formatted_price ?? 'N/A' }}
                                </div>
                                <div class="bks-info__row">
                                    <span>Số khách:</span>
                    ...
                    <div class="bks-dates">
                        <div class="bks-date">
                            ...
                            <div>
                                ...
                                <div class="bks-date__value">{{ $booking->formatted_check_in ?? 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="bks-date">
                            ...
                            <div>
                                ...
                                <div class="bks-date__value">{{ $booking->formatted_check_out ?? 'N/A' }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bks-services">
                        ...
                        <div class="bks-services__list">
                            ...
                            <div class="bks-svc-row">
                                <div class="bks-svc-row__left">
                                    <div class="bks-svc__name">{{ $svc->service_name }}</div>
                                    <div class="bks-svc__meta">
                                        <span class="bks-chip">{{ $svc->pricing_label }}</span>
                                        @if($svc->scheduled_fmt)
                                        <span class="bks-dot">•</span>
                                        <span class="bks-muted">Lịch: {{ $svc->scheduled_fmt }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="bks-svc-row__qty">x{{ $svc->quantity_int }}</div>
                                <div class="bks-svc-row__right">
                                    <div class="bks-svc__unit">{{ $svc->unit_price_fmt }}</div>
                                    <div class="bks-svc__sum">{{ $svc->subtotal_fmt }}</div>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="bks-services__total">
                            ...
                            <span class="bks-strong">{{ $services_total_fmt }}</span>
                        </div>
                        @else
                    ...
                    <div class="bks-actions">
                        <a href="{{ route('index') }}" class="bks-btn bks-btn--primary">
                            <i class="fas fa-home"></i> Về trang chủ
                        </a>
                        <a href="{{ route('booking.history', ['userId' => Auth::id()]) }}" class="bks-btn bks-btn--ghost">
            ...
            <aside class="bks-side">
                ...
                <div class="bks-side__row">
                    <span>Giá phòng ({{ $booking->nights ?? 1 }} đêm)</span>
                    <span>{{ $room_only_total_fmt }}</span>
                </div>
                <div class="bks-side__row">
                    <span>Dịch vụ</span>
                    <span>{{ $services_total_fmt }}</span>
                </div>
                @if(!empty($voucher))
                <div class="bks-side__row bks-side__row--discount">
                    <span>Giảm giá</span>
                    <span>-{{ $discount_amount_fmt }}</span>
                </div>
                @endif
