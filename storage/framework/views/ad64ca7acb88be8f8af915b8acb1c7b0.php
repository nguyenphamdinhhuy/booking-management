  ...
  <div class="bk-header__bar">
    ...
    <nav class="bk-header__nav">
      <ul class="bk-header__nav-list">
        ...
        <li><a href="<?php echo e(route('getAllPost')); ?>" class="bk-header__nav-link">Bài Viết</a></li>
        <li><a href="<?php echo e(route('user.vouchers')); ?>" class="bk-header__nav-link">Ưu đãi</a></li>
        <li><a href="<?php echo e(route('about')); ?>" class="bk-header__nav-link">Giới thiệu</a></li>
        <?php if(auth()->guard()->check()): ?>
        <li><a href="<?php echo e(route('booking.history', ['userId' => auth()->id()])); ?>" class="bk-header__nav-link">Hóa đơn</a></li>
        <li><a href="<?php echo e(route('contact.create')); ?>" class="bk-header__nav-link">Liên hệ</a></li>
        <?php endif; ?>
        <!-- <li><a href="#" class="bk-header__nav-link">Hỗ trợ</a></li> -->
        <li><a href="<?php echo e(route('all_rooms')); ?>" class="bk-header__nav-link">Chỗ nghỉ</a></li>
      </ul>
    </nav>
    ...
    <div class="bk-header__actions">
      ...
      <div class="user-dropdown">
        <div class="profile-trigger" onclick="toggleProfileDropdown()">
          <img
            src="<?php echo e(Auth::user()->avatar ? Auth::user()->avatar : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name)); ?>"
...
</script><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/layout/navigation.blade.php ENDPATH**/ ?>