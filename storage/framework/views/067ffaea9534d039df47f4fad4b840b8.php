...
<header class="bk-header">
  <div class="bk-header__bar">
    ...
    <?php endif; ?>
        ...
        <li><a href="<?php echo e(route('all_rooms')); ?>" class="bk-header__nav-link">Chỗ nghỉ của Quý vị</a></li>
      </ul>
    </nav>
  ...
  <nav class="bk-header__mobile-nav" aria-label="Mobile menu">
    ...
    <ul>
      ...
      <li><a href="<?php echo e(route('contact.create')); ?>"><i class="fa-solid fa-headset"></i> Liên hệ</a></li>
...
</script><?php /**PATH F:\backup\resources\views/layout/navigation.blade.php ENDPATH**/ ?>