...
<div class="content-section">
    <form action="<?php echo e(route('admin.roomType.store')); ?>"
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text"
                    ...
                    value="<?php echo e(old('type_name')); ?>"
            ...
            <div class="form-group">
                ...
                <select id="max_guests"
                    ...
                    <?php for($i = 1; $i <= 20; $i++): ?>
                        <option value="<?php echo e($i); ?>" <?php echo e(old('max_guests') == $i ? 'selected' : ''); ?>>
                        <?php echo e($i); ?> khách
                        </option>
                        <?php endfor; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select id="number_beds"
                    ...
                    <?php for($i = 1; $i <= 10; $i++): ?>
                        <option value="<?php echo e($i); ?>" <?php echo e(old('number_beds') == $i ? 'selected' : ''); ?>>
                        <?php echo e($i); ?> giường
                        </option>
                        <?php endfor; ?>
                </select>
            ...
            <div class="form-group full-width">
                ...
                <div id="amenityPicker"
                    ...
                    data-selected='<?php echo json_encode(old("amenities", []), 512) ?>'>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/admin/room_types/create.blade.php ENDPATH**/ ?>