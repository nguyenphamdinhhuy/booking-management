...
<div class="table-container">
    ...
    <div class="table-header">
        <h2 class="table-title">Danh sách voucher (<span id="voucherCount"><?php echo e($vouchers->count()); ?></span> mã)</h2>
        <div class="table-actions">
            <a href="<?php echo e(route('vouchers.create')); ?>" class="btn btn-primary">
    ...
    <!-- Bộ lọc -->
    <form id="filterForm" method="GET" action="<?php echo e(route('vouchers.management')); ?>">
        <div class="filter-bar">
            ...
            <div class="filter-group">
                ...
                <input type="text" name="search" class="filter-input" placeholder="Mã voucher, mô tả..."
                    value="<?php echo e(request('search')); ?>" onkeyup="searchVouchers(this.value)">
            </div>
    ...
    <div class="table-responsive">
        <table class="data-table">
            ...
            <tbody id="voucherTableBody">
                ...
                <tr>
                    <td><?php echo e($voucher->v_id); ?></td>
                    <td><strong><?php echo e($voucher->v_code); ?></strong></td>
                    <td><?php echo e($voucher->discount_percent); ?>%</td>
                    <td><?php echo e(\Carbon\Carbon::parse($voucher->start_date)->format('d/m/Y H:i')); ?></td>
                    <td><?php echo e(\Carbon\Carbon::parse($voucher->end_date)->format('d/m/Y H:i')); ?></td>
                    <td>
                    ...
                    <td>
                        <?php echo e($voucher->description ? Str::limit($voucher->description, 50) : 'Không có mô tả'); ?>

                    </td>
                    <td>
                        <div class="action-buttons">

                            <a href="<?php echo e(route('vouchers.edit', $voucher->v_id)); ?>" class="btn btn-warning btn-sm" title="Chỉnh sửa">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="<?php echo e(route('vouchers.delete', $voucher->v_id)); ?>" class="btn btn-danger btn-sm" title="Xóa" onclick="return confirm('Bạn có chắc muốn xóa voucher này?')">
...
<div id="routeContainer" data-url="<?php echo e(route('vouchers.management')); ?>"></div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/admin/vouchers/vouchers_management.blade.php ENDPATH**/ ?>