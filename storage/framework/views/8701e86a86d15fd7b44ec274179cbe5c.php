    ...
    <form action="<?php echo e(route('admin.rooms.store')); ?>" enctype="multipart/form-data" method="POST" class="room-form" id="addRoomForm">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select id="rt_id"
                    name="rt_id"
                    class="form-select <?php echo e($errors->has('rt_id') ? 'error' : ''); ?>">
                    ...
                    <option value="<?php echo e($roomType->rt_id); ?>"
                        <?php echo e(old('rt_id') == $roomType->rt_id ? 'selected' : ''); ?>

                        data-base-price="<?php echo e($roomType->base_price); ?>"
                        data-max-guests="<?php echo e($roomType->max_guests); ?>"
                        data-number-beds="<?php echo e($roomType->number_beds); ?>"
                        data-room-size="<?php echo e($roomType->room_size); ?>"
                        data-amenities="<?php echo e($roomType->amenities); ?>">
                ...
                <?php if($errors->has('rt_id')): ?>
                <div class="error-message">
                    <i class="fas fa-exclamation-circle"></i>
                    <?php echo e($errors->first('rt_id')); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/admin/rooms/add_room.blade.php ENDPATH**/ ?>