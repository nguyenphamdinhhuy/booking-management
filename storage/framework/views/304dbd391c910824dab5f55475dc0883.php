            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="max_quantity" id="max_quantity" class="form-input"
                        value="<?php echo e(old('max_quantity', $service->max_quantity)); ?>" min="1">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="service_time" id="service_time" class="form-input"
                        value="<?php echo e(old('service_time', $service->service_time)); ?>" placeholder="VD: 8h00 - 17h00">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" id="location" class="form-input"
                        value="<?php echo e(old('location', $service->location)); ?>" placeholder="VD: Sảnh A, tầng 1">
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="note" id="note" class="form-textarea"
                        rows="3"><?php echo e(old('note', $service->note)); ?></textarea>
                </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/admin/service/edit_service.blade.php ENDPATH**/ ?>