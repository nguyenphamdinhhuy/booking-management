  ...
  <div class="bk-header__bar">
    ...
    <nav class="bk-header__nav">
      <ul class="bk-header__nav-list">
        ...
        <li><a href="<?php echo e(route('booking.history', ['userId' => auth()->id()])); ?>" class="bk-header__nav-link">Hóa đơn của tôi</a></li>
        <?php endif; ?>
...
</script><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app\resources\views/layout/navigation.blade.php ENDPATH**/ ?>