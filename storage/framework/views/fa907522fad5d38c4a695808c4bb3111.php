            ...
            <div class="rooms-list">
                <?php if($rooms && $rooms->count() > 0): ?>
                    <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('rooms_detail', ['id' => $room->r_id])); ?>"
                            class="room-card <?php echo e(!$room->available ? 'room-unavailable' : ''); ?>">
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\backup\resources\views/user/all_rooms.blade.php ENDPATH**/ ?>