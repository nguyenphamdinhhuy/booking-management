        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="v_code" name="v_code" class="form-input"
                    value="<?php echo e(old('v_code')); ?>" maxlength="10"
            ...
            <div class="form-group">
                ...
                <input type="number" id="discount_percent" name="discount_percent" class="form-input"
                    value="<?php echo e(old('discount_percent')); ?>" min="0" max="75" step="0.5"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/admin/vouchers/add_vouchers.blade.php ENDPATH**/ ?>