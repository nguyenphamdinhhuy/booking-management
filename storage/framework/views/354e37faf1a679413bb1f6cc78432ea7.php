...
<div class="table-container">
    ...
    <div class="table-header">
        <h2 class="table-title">Danh sách loại phòng (<span id="roomTypeCount"><?php echo e($roomTypes->count()); ?></span> loại phòng)</h2>
        <div class="table-actions">
            <a href="<?php echo e(route('admin.roomType.create')); ?>" class="btn btn-primary">
                <i class="fas fa-plus"></i>
                Thêm loại phòng mới
            </a>

            <a href="<?php echo e(route('admin.roomType.trash')); ?>" class="btn btn-secondary">
                ...
                ?>
                <?php if($trashCount > 0): ?>
                <span class="badge badge-warning"><?php echo e($trashCount); ?></span>
                <?php endif; ?>
            </a>
        </div>
    </div>
    ...
    <!-- Filter Bar -->
    <form id="filterForm" method="GET" action="<?php echo e(route('admin.roomType.index')); ?>">
        ...
        <table class="data-table">
            ...
            <tbody id="roomTypesTableBody">
                ...
                <tr>
                    ...
                    <td><?php echo e($roomType->created_at->format('d/m/Y H:i')); ?></td>
                    <td>
                        <div class="action-buttons">
                            <a href="<?php echo e(route('admin.roomType.show', $roomType->rt_id)); ?>" class="btn btn-primary btn-sm" title="Xem chi tiết">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="<?php echo e(route('admin.roomType.edit', $roomType->rt_id)); ?>" class="btn btn-warning btn-sm" title="Chỉnh sửa">
                                <i style="color: #fff;" class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('admin.roomType.destroy', $roomType->rt_id)); ?>" method="POST" style="display: inline-block;">
                                <?php echo csrf_field(); ?>
    ...
    <div class="d-flex justify-content-center mt-3">
        <?php echo e($roomTypes->links('pagination::bootstrap-4')); ?>
...
<div id="routeContainer" data-url="<?php echo e(route('admin.roomType.index')); ?>"></div>
...
<script>
    ...
    function clearFilters() {
        window.location.href = "<?php echo e(route('admin.roomType.index')); ?>";
    }
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\F-poly\graduation_project\booking_laravel_project\booking_app - Copy\resources\views/admin/room_types/index.blade.php ENDPATH**/ ?>